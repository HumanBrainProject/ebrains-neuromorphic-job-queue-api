...
.. _undefined.clbActivity:

Member: ``clbActivity``: ``clb-activity`` directive is displays an activity retrieved by
...
Member: ``clbFeed``: ``clb-feed`` directive displays a feed of activity retrieved by
