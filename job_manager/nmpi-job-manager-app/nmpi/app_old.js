(function() {
  ...
  .config(
    function ( $httpProvider, $stateProvider, $locationProvider, $rootScopeProvider, $resourceProvider, $scope ) 
    {
      $resourceProvider.defaults.stripTrailingSlashes = false;

      window.addEventListener('message', function(event, $stateProvider, $scope) {
        //console.log(event);
        ...
        if(msg.data.state.state == "list"){
          console.log("state : "+msg.data.state.job_id);
        ...
        if(msg.data.state.state == "detail") {
          console.log("state : "+msg.data.state.page);
